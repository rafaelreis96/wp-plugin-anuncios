            ...
            frame.on('select', function (){
                ...
                selection.each(function(attachment) {
                    ...
                    if(attachment.attributes.id) {
                        wppaRenderImageElement(attachment.attributes.id, attachment.attributes.url);
                    }
                });
...
if(wppaBtnRemove) {
    wppaBtnRemove.addEventListener('click', function(event) {
...
function wppaRenderImageElement(id, url) {
    wppaBanner.value = id;
